...
public class ProductController {
    ...
    public ResponseEntity<?> doGetReviewComments(@PathVariable("reviewSeq") Long reviewSeq,
    ...
    public ResponseEntity<?> doGetReviewCommentReplies(@PathVariable("commentSeq") Long commentSeq,
                                                       @RequestParam("page") int page) {
     ...
     */
    @PutMapping("/reviews")
    public ResponseEntity<?> doPutReview(@ModelAttribute ReviewModifyRequest param) {
        ProductValidator.validate(param);
